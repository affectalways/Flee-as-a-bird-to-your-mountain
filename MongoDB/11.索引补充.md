...
- [索引类型](#索引类型)
  ...
  - [全文索引](#全文索引)
  - [哈希索引](#哈希索引)
- [索引和explain分析](#索引和explain分析)
  - [索引管理](#索引管理)
  - [explain分析](#explain分析)
  - [queryPlanner默认参数](#queryPlanner默认参数)
  - [executionStats参数](#executionStats参数)
  - [executionStats返回逐层分析](#executionStats返回逐层分析)
- [慢查询分析](#慢查询分析)
- [MongoDB索引底层实现原理分析](#MongoDB索引底层实现原理分析)
- [参考链接](#参考链接)
...
- https://blog.rubinchu.com/2021/11/08/mongodb%E4%B9%8B%E7%B4%A2%E5%BC%95/