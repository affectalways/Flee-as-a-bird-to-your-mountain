...
​		双指针，指的是在遍历对象的过程中，不再使用单个指针进行访问，而是使用两个相同方向（*快慢指针*）或者相反方向（*对撞指针*）的指针进行扫描，从而达到相应的目的。
...
![](D:\git_code\Flee-as-a-bird-to-your-mountain\算法\pictures\双指针1.jpg)
...
![](D:\git_code\Flee-as-a-bird-to-your-mountain\算法\pictures\双指针3.jpg)
...
![](D:\git_code\Flee-as-a-bird-to-your-mountain\算法\pictures\双指针4.jpg)
